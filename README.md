...
### 🛠️ Tech Stack
* **Core:** HTML5, CSS3, JavaScript (ES6+), React.js, Vite, PWA.
* **Bitcoin:** Mempool APIs, Lightning Network (BOLT11), Self-Custody standards.
* **AI Ops:** Prompt Engineering, Cursor Composer, LLM-assisted architecture.

---

### ⚡ Featured Projects

#### 🌐 [Personal Portfolio Hub](https://github.com/LuisRM-btc/luis-portfolio)
My central developer hub. A "Dark Glassmorphism" style portfolio built to showcase my Bitcoin projects.
* **Tech:** React.js, Vite, Responsive Design.
* **Live Demo:** [View Portfolio](https://luis-portfolio-ebon.vercel.app/)

#### 💱 [Sats Converter PWA](https://github.com/LuisRM-btc/sats-converter)
...
### 📫 Connect with me
* **Web:** [luis-portfolio.vercel.app](https://luis-portfolio-ebon.vercel.app/)
