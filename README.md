...
### 🚀 Technical Roadmap
While the current stack prioritizes speed and functionality using Javascript, my production roadmap includes:
* **Migration to TypeScript:** To ensure type safety across financial calculations.
* **React Query:** For better server state management and caching.
* **E2E Testing:** Implementing Playwright for full user journey testing.
